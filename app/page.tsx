      ...
      <footer className="border-t border-zinc-200/60 py-10 dark:border-zinc-800/60">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-6 sm:flex-row sm:justify-between">
          ...
          <p className="text-xs text-zinc-400">
            © {new Date().getFullYear()} Promote. Not affiliated with Meta, LinkedIn, Google, or YouTube.
          </p>
...
const steps = [
  {
    ...
    body: "Sign in with Google, then connect Instagram, Facebook, LinkedIn, or YouTube through their official OAuth flows.",
  },
  {
